...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for gallery in orm.Gallery.objects.all():
            duplicator.duplicate_tags(gallery)

        for category in orm.GalleryCategory.objects.all():
            duplicator.duplicate_tags(category)
    ...
    complete_apps = ['taggit', 'tagging', 'galleries']
    symmetrical = True
