...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mediasources_vimeovideo', (
            ...
            ('publish_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vimeovideo_publish_by_user', null=True, to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vimeovideo_created_by_user', to=orm['auth.User'])),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vimeovideo_updated_by_user', to=orm['auth.User'])),
            ...
            ('_api_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('mediasources', ['VimeoVideo'])


    def backwards(self, orm):
        
        # Deleting model 'VimeoVideo'
        db.delete_table('mediasources_vimeovideo')
