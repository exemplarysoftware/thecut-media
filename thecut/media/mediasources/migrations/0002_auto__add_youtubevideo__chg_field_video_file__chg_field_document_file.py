...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.file'
        db.alter_column('mediasources_video', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Document.file'
        db.alter_column('mediasources_document', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
