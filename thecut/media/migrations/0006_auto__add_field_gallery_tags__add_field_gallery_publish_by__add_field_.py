...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('media_gallery', 'tags', self.gf('tagging.fields.TagField')(null=True), keep_default=False)

        # Adding field 'Gallery.publish_by'
        db.add_column('media_gallery', 'publish_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gallery_publish_by_user', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Gallery.template'
        db.add_column('media_gallery', 'template', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gallery.tags'
        db.delete_column('media_gallery', 'tags')

        # Deleting field 'Gallery.publish_by'
        db.delete_column('media_gallery', 'publish_by_id')

        # Deleting field 'Gallery.template'
        db.delete_column('media_gallery', 'template')
