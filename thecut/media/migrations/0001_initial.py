...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'media.attachedphoto': {
            'Meta': {'object_name': 'AttachedPhoto'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mediaset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['media.MediaSet']"}),
        ...
        'media.mediaset': {
            ...
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['photologue.Photo']", 'null': 'True', 'through': "'AttachedPhoto'", 'blank': 'True'})
        },
        'photologue.gallery': {
