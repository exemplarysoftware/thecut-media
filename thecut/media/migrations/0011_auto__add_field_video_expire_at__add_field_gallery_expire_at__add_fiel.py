...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.expire_at'
        db.add_column('media_video', 'expire_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Gallery.expire_at'
        db.add_column('media_gallery', 'expire_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Document.expire_at'
        db.add_column('media_document', 'expire_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.expire_at'
        db.delete_column('media_video', 'expire_at')

        # Deleting field 'Gallery.expire_at'
        db.delete_column('media_gallery', 'expire_at')

        # Deleting field 'Document.expire_at'
        db.delete_column('media_document', 'expire_at')
    ...
    models = {
        ...
        'media.video': {
            'Meta': {'ordering': "['-publish_at', 'title']", 'object_name': 'Video'},
            'content': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
