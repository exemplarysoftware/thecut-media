...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gallery.image_order'
        db.add_column('media_gallery', 'image_order', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=250, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gallery.image_order'
        db.delete_column('media_gallery', 'image_order')
