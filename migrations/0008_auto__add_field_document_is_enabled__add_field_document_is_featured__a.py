...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.is_enabled'
        db.add_column('media_document', 'is_enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Document.is_featured'
        db.add_column('media_document', 'is_featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Document.publish_at'
        db.add_column('media_document', 'publish_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 1, 1, 0, 0)), keep_default=False)

        # Adding field 'Document.publish_by'
        db.add_column('media_document', 'publish_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='document_publish_by_user', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.is_enabled'
        db.delete_column('media_document', 'is_enabled')

        # Deleting field 'Document.is_featured'
        db.delete_column('media_document', 'is_featured')

        # Deleting field 'Document.publish_at'
        db.delete_column('media_document', 'publish_at')

        # Deleting field 'Document.publish_by'
        db.delete_column('media_document', 'publish_by_id')
    ...
    models = {
        ...
        'media.mediaset': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['media.Document']", 'null': 'True', 'blank': 'True'}),
            'galleries': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['media.Gallery']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_order': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['photologue.Photo']", 'null': 'True', 'blank': 'True'}),
