...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'AttachedPhoto'
        db.delete_table('media_attachedphoto')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'AttachedPhoto'
        db.create_table('media_attachedphoto', (
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Photo'])),
            ('mediaset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.MediaSet'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal('media', ['AttachedPhoto'])
    ...
    models = {
        ...
        'media.mediaset': {
            ...
            'galleries': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['photologue.Gallery']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
